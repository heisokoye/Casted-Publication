    ...
    <div >
        ...
        >
           <div className=' mx-auto pr-5  md:w-[90%] lg:w-[95%] p-2 justify-between flex items-center'>
                ...
                {/* Desktop navigation links & Dashboard logout */}
                <div className='flex items-center gap-3'>
                    {isDashboard ? (
                        <button onClick={handleLogout} className='px-3.5 py-1.5 md:px-4 md:py-2 bg-orange-400 rounded-lg text-xs md:text-sm font-medium cursor-pointer text-white hover:bg-orange-500 transition-colors'> 
                            Logout 
                        </button>
                    ) : (
                        <>
